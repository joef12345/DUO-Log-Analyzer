...
11. Create a windows task to run the program every 5 minutes. Sooner than 5 minutes will cause DUO API rate limiting. Hace the task execute `duo log analyzer.exe -run` 
